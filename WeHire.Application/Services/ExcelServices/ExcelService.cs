...
namespace WeHire.Application.Services.ExcelServices
{
    public class ExcelService : IExcelService
    {
                                      ...
                                      int dayCountInMonth, List<string> dayRangeInMonth, List<PaySlipModel> paySlips)
        {
            ...
            Color redColor = ColorTranslator.FromHtml("#faebde");
            ...
            using (var package = new ExcelPackage())
            {
                ...
                var cellA2E4 = worksheet.Cells["A2:E4"];
                cellA2E4.Style.Fill.PatternType = ExcelFillStyle.Solid;
                cellA2E4.Style.Fill.BackgroundColor.SetColor(blueBlurColor);
