...
namespace WeHire.Application.Utilities.GlobalVariables
{
    public static class GlobalVariable
    {
        ...
        {        
            ...
            public const string CONTRACT_NOT_EXIST = "Contract not exist!";
            ...
            public const string JOB_POSITION_NOT_EXIST = "JobPosition not exists!";
        }
        ...
        public static class ErrorField
        {
            ...
            public const string JOB_POSITION_FIELD  = "JobPosition";
